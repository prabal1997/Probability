function [ output_args ] = ezdraw(input, output, show_mean, show_smooth, label_names, legend_names, style, stem_enabled, xlim_array, ylim_array, buffer, smooth_config, line_width, grid_count, important_only)
    ...
    if (important_only)
        ylim_array(1) = 9/10*mean_val;
        ylim_array(2) = 11/10*mean_val;
    end
    ylim(ylim_array);
